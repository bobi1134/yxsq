...
public class EmailUtil {
	...
	public static boolean send(String to, String subject, String msg) {
		...
		// 发送人
		props.put("mail.from", "mrx_email@163.com");
		...
		try {
			...
			// 连接邮件服务器
			ts.connect("mrx_email@163.com", "test123"); 
			// 第三步: 创建邮件消息体
			...
			//设置发件人地址
			message.setFrom(new InternetAddress(nick + " <mrx_email@163.com>"));
			// 第五步：设置接收人信息
	...
	public static void main(String[] args) {
		EmailUtil.send("761328790@qq.com", "四川农业大学校车票购票系统", "恭喜注册成功，请激活！");
	}
}
