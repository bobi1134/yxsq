	...
	public void doTag() throws JspException, IOException {
		...
		if (recordCount > 0){
			...
			res.append("<table align='center' style='font-size:14px;'>")
			    ...
			    .append("<input type='button' onclick='jump_page_fn();' value='确定' style='width:40px;height:19px;border:0 none;background:#5a98de;color:#fff;font-size:12px;border-radius:3px;margin-left:5px;font-family:微软雅黑;line-height:19px;'/>")
			    .append("</td></tr>")
			    
			    .append("<tr align='left'><td>小提示：总共<font color='red'>"+recordCount)
			...
			res.append("   alert('请输入[1-"+ totalSize +"]之间的页码！');");
			res.append("}else{");
			...
			res.append("<table align='center' style='font-size:14px;'><tr>")
			   .append("<td>小提示：总共<font color='red'>0</font>条记录，当前显示0-0条记录。</td>")
			   .append("</tr></table>");
		}
