...
<html>
	...
	<body>
		...
		<div class="ss">
			<div class="_1">
				您当前有<span class="num">${prepare_user_Count}</span>条新Y主申请未处理！
				<img src="${pageContext.request.contextPath}/admin_file/images/new.gif" width="33" height="16"/>
			</div>
			<div class="_2">
				您当前没有新Y主申请要处理！您可以<a href="${pageContext.request.contextPath}/admin/user/admin_selectAllUser.action">查看</a>所有用户！
			</div>
		</div>
		<table width="100%" border="1" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<s:iterator value="prepareYZs">
				<tr onMouseOver="move(this);" onMouseOut="out(this);" height="30">
					<td><s:property value="id"/></td>
					<td><s:property value="apply_sq"/></td>
					<td><s:property value="apply_usernickname"/></td>
					<td><s:property value="introduce"/></td>
					<td><s:property value="apply_reason"/></td>
					<td align="center"><a href="${pageContext.request.contextPath}/admin/user/admin_passPrepareUser.action?userId=${userId}&sqId=${sqId}&id=${id}" onclick="return confirm('你确定允许该社区建立吗？')"><img src="${pageContext.request.contextPath}/admin_file/images/pass.png" width="15" height="15" title="通过"/></a></td>
					<td align="center"><a href="${pageContext.request.contextPath}/admin/user/admin_failPrepareUser.action?id=${id}" onclick="return confirm('你确定不允许该社区建立吗？')"><img src="${pageContext.request.contextPath}/admin_file/images/fail.png" width="15" height="15" title="不通过"/></a></td>
				</tr>
			</s:iterator>
		</table>
		<div class="page">
