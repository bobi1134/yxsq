		...
		<table width="100%" border="1" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<s:iterator value="imgs">
				<tr onMouseOver="move(this);" onMouseOut="out(this);" height="30">
					...
					<td align="center"><a href="javascript:void(0);" title="预览" onclick="prevImg_2(${id});"><img src="${pageContext.request.contextPath}/admin_file/images/prev.gif" width="15" height="15"/></a></td>
					<td align="center"><a href="${pageContext.request.contextPath}/admin/img/admin_updateBjPage.action?id=${id}" title="更换"><img src="${pageContext.request.contextPath}/admin_file/images/update.gif" width="15" height="15"/></a></td>
				</tr>
			</s:iterator>
		</table>
		<div class="page">
			<xy_2:pager_2 pageIndex="${pageModel.pageIndex}" pageSize="${pageModel.pageSize}" recordCount="${pageModel.recordCount}" submitUrl="${pageContext.request.contextPath}/admin/img/admin_selectbjImg.action?pageModel.pageIndex={0}"/>
		</div>
	</body>
</html>