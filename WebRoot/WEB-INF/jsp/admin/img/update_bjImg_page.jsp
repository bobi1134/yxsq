...
<html>
	<head>
		<title> update_bjImg_page.jsp </title>
	...
	<body>
		<div class="dqwz">
			<a href="${pageContext.request.contextPath}/admin/img/admin_selectbjImg.action">返回</a>
		</div>
		<div class="ss">
			<fieldset style="border:1px dashed;width:400px;margin:100px auto">
				<legend>首页背景图片修改</legend>
				<div class="form">
					<form action="${pageContext.request.contextPath}/admin/img/admin_updateBjImg.action" method="post" id="updateForm" enctype="multipart/form-data">
						图片信息：<input type="text" name="img_title" id="img_title" autocomplete="off" value="${img.img_title}"/><br/>
						上传图片：<input type="file" class="file" name="bjImg" id="bjFile"/>
