...
<html>
	...
	<body>
		<div class="dqwz">
			当前位置：图片管理&gt;&gt;首页图片&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/admin/img/admin_selectdhImg.action" target="content">导航图片操作</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/admin/img/admin_selectbjImg.action">背景图片操作</a>
		</div>
		<table width="100%" border="1" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<s:iterator value="imgs">
				<tr onMouseOver="move(this);" onMouseOut="out(this);" height="30">
					...
					<s:if test="status==1">
						<td align="center"><a href="javascript:void(0);" title="轮播图片预览" onclick="prevImg_1(${id});"><img src="${pageContext.request.contextPath}/admin_file/images/prev.gif" width="15" height="15"/></a></td>
					</s:if>
					<s:else>
						<td align="center"><a href="javascript:void(0);" title="背景图片预览" onclick="prevImg_2(${id});"><img src="${pageContext.request.contextPath}/admin_file/images/prev.gif" width="15" height="15"/></a></td>
					</s:else>
				</tr>
			</s:iterator>
		</table>
		<div class="page">
			<xy_2:pager_2 pageIndex="${pageModel.pageIndex}" pageSize="${pageModel.pageSize}" recordCount="${pageModel.recordCount}" submitUrl="${pageContext.request.contextPath}/admin/img/admin_selectImgs.action?pageModel.pageIndex={0}"/>
		</div>
	</body>
</html>